...
import com.dienvu.commons.adapters.ManageBlockedNumbersAdapter
import com.dienvu.commons.dialogs.AddBlockedNumberDialog
import com.dienvu.commons.dialogs.ExportBlockedNumbersDialog
import com.dienvu.commons.dialogs.FilePickerDialog
import com.dienvu.commons.extensions.*
import com.dienvu.commons.helpers.*
import com.dienvu.commons.helpers.BlockedNumbersExporter.ExportResult
import com.dienvu.commons.interfaces.RefreshRecyclerViewListener
...
class ManageBlockedNumbersActivity : BaseSimpleActivity(), RefreshRecyclerViewListener
{
    ...
    {
        manage_blocked_numbers_placeholder.text = getString(
            if (isDefaultDialer()) R.string.not_blocking_anyone
            else R.string.must_make_default_dialer)
        manage_blocked_numbers_placeholder_2.text = getString(
            if (isDefaultDialer()) R.string.add_a_blocked_number
            else R.string.set_as_default)
    }
    ...
    private fun tryExportBlockedNumbers()
    {
        if (isQPlus())
        {
            ExportBlockedNumbersDialog(this, baseConfig.lastBlockedNumbersExportPath, true)
            { file ->
        ...
        else
        {
            handlePermission(PERMISSION_WRITE_STORAGE) {
                if (it)
                {
                    ExportBlockedNumbersDialog(this, baseConfig.lastBlockedNumbersExportPath, false)
                    { file ->
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?)
    {
            ...
            isDefaultDialer())
        {
            ...
            requestCode == PICK_IMPORT_SOURCE_INTENT &&
            ...
            resultData.data != null)
        {
            ...
            requestCode == PICK_EXPORT_FILE_INTENT &&
            resultCode == Activity.RESULT_OK &&
            resultData != null &&
            resultData.data != null)
        {
