...
class NewCustomizationActivity : NewBaseSimpleActivity() {
    ...
    private var curPrimaryLineColorPicker: NewLineColorPickerDialog? = null
    ...
    private fun themePickerClicked() {
        ...
        RadioGroupDialog(this@NewCustomizationActivity, items, curSelectedThemeId) {
    ...
    private fun pickPrimaryColor() {
        ...
        curPrimaryLineColorPicker = NewLineColorPickerDialog(this, curPrimaryColor, true, toolbar = customization_toolbar) { wasPositivePressed, color ->
    ...
    private fun pickAppIconColor() {
        NewLineColorPickerDialog(this, curAppIconColor, false, R.array.md_app_icon_colors, getAppIconIDs()) { wasPositivePressed, color ->
            if (wasPositivePressed) {
