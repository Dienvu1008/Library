...
import com.dienvu.commons.models.MyTheme
import com.dienvu.commons.models.RadioItem
import com.dienvu.commons.models.SharedTheme
import com.dienvu.commons.views.MyTextView
import kotlinx.android.synthetic.main.new_activity_customization.*
...
class CustomizationActivity : BaseSimpleActivity()
{
    ...
    private val THEME_PINK = 10
    private val THEME_BLUE = 11
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        setContentView(R.layout.new_activity_customization)
        ...
        if (baseConfig.defaultNavigationBarColor == INVALID_NAVIGATION_BAR_COLOR &&
            baseConfig.navigationBarColor == INVALID_NAVIGATION_BAR_COLOR)
        {
        ...
        customization_app_icon_color_label.beGone()
        customization_app_icon_color.beGone()

        setupOptionsMenu()
        refreshMenuItems()
        isThankYou = packageName.removeSuffix(".debug") == "com.dienvu.thankyou"
        initColorVariables()
    ...
    {
        //toolbar.menu.findItem(R.id.save).isVisible = hasUnsavedChanges
        ...
        predefinedThemes.apply {
            ...
            put(THEME_LIGHT,
                MyTheme(
                    ...
                    R.color.md_purple//R.color.color_primary
                )
            )
            put(
                THEME_DARK,
            ...
            //put(THEME_WHITE,
                //MyTheme(
                    ...
                    //android.R.color.white,
                    //R.color.md_red_700//R.color.color_primary
                //))
            //put(THEME_BLACK_WHITE,
                //MyTheme(
                    //R.string.black_white,
                    //android.R.color.white,
                    //android.R.color.black,
                    //android.R.color.black,
                    //R.color.md_red_700 //R.color.md_grey_black
                //))
            //put(THEME_PINK,
                //MyTheme(
                    //R.string.pink_theme,
    ...
    private fun themePickerClicked()
    {
        ...
        RadioGroupDialog(this@CustomizationActivity, items, curSelectedThemeId)
        {
            ...
            apply_to_all_holder.beVisibleIf(
                curSelectedThemeId != THEME_AUTO &&
                        curSelectedThemeId != THEME_SYSTEM &&
                        curSelectedThemeId != THEME_SHARED &&
                        !hideGoogleRelations)
    ...
    private fun updateAutoThemeFields()
    {
        arrayOf(
            ...
            customization_navigation_bar_color_holder).forEach {
    ...
    private fun saveChanges(finishAfterSave: Boolean)
    {
        ...
        baseConfig.apply {
            ...
            navigationBarColor =
                if (curNavigationBarColor == INVALID_NAVIGATION_BAR_COLOR)
                {
                -2
                }
                else
    ...
    {
        customization_accent_color_holder.beVisibleIf(
            curSelectedThemeId == THEME_WHITE ||
                    isCurrentWhiteTheme() ||
    ...
    {
        if (!packageName.startsWith("com.dienvu.", true) && baseConfig.appRunCount > 50)
        {
            finish()
            return
        }
        curPrimaryLineColorPicker =
            LineColorPickerDialog(this, curPrimaryColor, true, toolbar = customization_toolbar)
    ...
    private fun pickNavigationBarColor()
    {
        ColorPickerDialog(
            ...
            true,
            true,
            currentColorCallback = { updateNavigationBarColor(it, true) },
    ...
    private fun pickAppIconColor()
    {
        LineColorPickerDialog(
            ...
            getAppIconIDs()) { wasPositivePressed, color ->
            if (wasPositivePressed)
            {
