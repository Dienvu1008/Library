...
import com.dienvu.commons.overloads.times
...
const val BROADCAST_REFRESH_MEDIA = "com.dienvu.REFRESH_MEDIA"
...
val photoExtensions: Array<String> get() = arrayOf(
    ".jpg",
    ".png",
    ".jpeg",
    ".bmp",
    ...
    ".apng",
    ".avif")
val videoExtensions: Array<String> get() = arrayOf(
    ".mp4",
    ".mkv",
    ".webm",
    ".avi",
    ...
    ".m4v",
    ".3gpp")
val audioExtensions: Array<String> get() = arrayOf(
    ".mp3",
    ".wav",
    ".wma",
    ".ogg",
    ...
    ".flac",
    ".aac")
val rawExtensions: Array<String> get() = arrayOf(
    ".dng",
    ".orf",
    ".nef",
    ".arw",
...
val extensionsSupportingEXIF: Array<String> get() = arrayOf(
    ".jpg",
    ".jpeg",
    ".png",
    ".webp",
