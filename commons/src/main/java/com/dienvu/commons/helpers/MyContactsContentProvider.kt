package com.dienvu.commons.helpers
...
import com.dienvu.commons.extensions.getIntValue
import com.dienvu.commons.extensions.getStringValue
import com.dienvu.commons.models.PhoneNumber
import com.dienvu.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.dienvu.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.dienvu.dialer" && packageName != "com.dienvu.smsmessenger" && packageName != "com.dienvu.mytimemanagement.pro") {
                return contacts
            }
