...
import com.dienvu.commons.extensions.getInternalStoragePath
import com.dienvu.commons.extensions.getSDCardPath
import com.dienvu.commons.extensions.getSharedPrefs
...
open class BaseConfig(val context: Context)
{
    ...
    private fun getDefaultSDCardPath() =
        if (prefs.contains(SD_CARD_PATH)) ""
        else context.getSDCardPath()
    ...
    private fun getDefaultInternalPath() =
        if (prefs.contains(INTERNAL_STORAGE_PATH)) ""
        else context.getInternalStoragePath()
