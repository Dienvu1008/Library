package com.dienvu.commons.asynctasks
...
import com.dienvu.commons.helpers.CONFLICT_KEEP_BOTH
import com.dienvu.commons.helpers.CONFLICT_SKIP
import com.dienvu.commons.helpers.getConflictResolution
import com.dienvu.commons.helpers.isOreoPlus
...
class NewCopyMoveTask(
    val activity: NewBaseSimpleActivity, val copyOnly: Boolean, val copyMediaOnly: Boolean, val conflictResolutions: LinkedHashMap<String, Int>,
    ...
    private fun deleteProtectedFiles() {
        if (mFileDirItemsToDelete.isNotEmpty()) {
            val fileUris = activity.getFileUrisFromFileDirItemsNew(mFileDirItemsToDelete)
