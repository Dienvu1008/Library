...
import com.dienvu.commons.extensions.adjustAlpha
import com.dienvu.commons.extensions.onTextChangeListener
import com.dienvu.commons.extensions.value
import com.dienvu.commons.helpers.HIGHER_ALPHA
...
class MyTextInputLayout : TextInputLayout {
    ...
    fun setColors(textColor: Int, accentColor: Int, backgroundColor: Int)
    {
        try
        {
            ...
            val hintColor =
                if (editText!!.value.isEmpty()) textColor.adjustAlpha(HIGHER_ALPHA)
                else textColor
