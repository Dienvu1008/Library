...
import com.dienvu.commons.R.id.*
import com.dienvu.commons.extensions.baseConfig
import com.dienvu.commons.extensions.beVisibleIf
import com.dienvu.commons.extensions.setupDialogStuff
import com.dienvu.commons.helpers.CONFLICT_KEEP_BOTH
import com.dienvu.commons.helpers.CONFLICT_MERGE
import com.dienvu.commons.helpers.CONFLICT_OVERWRITE
...
class FileConflictDialog(
    ...
    val showApplyToAllCheckbox: Boolean,
    val callback: (resolution: Int, applyForAll: Boolean) -> Unit)
{
    ...
    init
    {
        view.apply {
            val stringBase =
                if (fileDirItem.isDirectory) R.string.folder_already_exists
                else R.string.file_already_exists
