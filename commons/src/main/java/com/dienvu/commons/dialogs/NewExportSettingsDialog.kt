...
class NewExportSettingsDialog(
    val activity: NewBaseSimpleActivity, val defaultFilename: String, val hidePath: Boolean,
        ...
        val view = activity.layoutInflater.inflate(R.layout.dialog_export_settings, null).apply {
            ...
            if (hidePath) {
                ...
                export_settings_path.setOnClickListener {
                    NewFilePickerDialog(activity, folder, false, showFAB = true) {
