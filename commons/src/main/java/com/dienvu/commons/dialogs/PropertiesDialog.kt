...
class PropertiesDialog()
{
    ...
    constructor(activity: Activity, path: String, countHiddenItems: Boolean = false) :this()
    {
        ...
        ensureBackgroundThread {
            ...
            if (!fileDirItem.isDirectory)
            {
                ...
                val exif =
                    if (isNougatPlus() && activity.isPathOnOTG(fileDirItem.path))
                    {
        ...
        else
        {
            ...
            if (activity.baseConfig.appId.removeSuffix(".debug") == "com.dienvu.filemanager.pro")
            {
    ...
    {
        val exif =
            if (isNougatPlus() && activity.isPathOnOTG(path))
            {
