...
import com.dienvu.commons.helpers.NavigationIcon
import com.dienvu.commons.interfaces.LineColorPickerListener
    ...
    val callback: (wasPositivePressed: Boolean, color: Int) -> Unit)
{
        ...
        view.apply {
            ...
            primary_line_color_picker.listener = object : LineColorPickerListener
            {
                override fun colorChanged(index: Int, color: Int)
                {
                    ...
                    val newColor =
                        if (isPrimaryColorPicker) secondary_line_color_picker.getCurrentColor()
                        else color
    ...
    {
        val targetView =
            if (isPrimaryColorPicker) view.secondary_line_color_picker
            else view.primary_line_color_picker
