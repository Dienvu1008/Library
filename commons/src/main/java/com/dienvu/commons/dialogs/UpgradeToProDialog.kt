...
import com.dienvu.commons.extensions.launchUpgradeToProIntent
...
class UpgradeToProDialog(val activity: Activity)
{
    ...
    {
        activity.launchViewIntent("https://medium.com/@dienvu/some-tgb's-apps-are-becoming-paid-d053268f0fb2")
    }
}
