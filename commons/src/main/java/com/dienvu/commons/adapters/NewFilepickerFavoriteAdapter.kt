...
import com.dienvu.commons.extensions.getTextSize
import com.dienvu.commons.views.MyRecyclerView
import kotlinx.android.synthetic.main.filepicker_favorite.view.*

class NewFilepickerFavoritesAdapter(
    activity: NewBaseSimpleActivity, val paths: List<String>, recyclerView: MyRecyclerView,
    itemClick: (Any) -> Unit
) : MyNewRecyclerViewAdapter(activity, recyclerView, itemClick) {
