package com.dienvu.commons.adapters
...
class NewFilepickerItemsAdapter(
    activity: NewBaseSimpleActivity,
    val fileDirItems: List<FileDirItem>,
    recyclerView: MyRecyclerView,
    itemClick: (Any) -> Unit)
    : MyNewRecyclerViewAdapter(activity, recyclerView, itemClick), RecyclerViewFastScroller.OnPopupTextUpdate
{
    ...
    private fun setupView(view: View, fileDirItem: FileDirItem) {
        view.apply {
            ...
            if (fileDirItem.isDirectory) {
                ...
                val placeholder = fileDrawables.getOrElse(fileDirItem.name.substringAfterLast(".").toLowerCase(
                    Locale.getDefault()), { fileDrawable })
