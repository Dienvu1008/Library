...
import com.dienvu.commons.interfaces.MyActionModeCallback
import com.dienvu.commons.views.MyRecyclerView

abstract class MyNewRecyclerViewAdapter(
    val activity: NewBaseSimpleActivity,
    val recyclerView: MyRecyclerView,
    val itemClick: (Any) -> Unit) :
    RecyclerView.Adapter<MyNewRecyclerViewAdapter.ViewHolder>() {
