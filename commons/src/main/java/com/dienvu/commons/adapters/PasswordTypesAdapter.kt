...
import com.dienvu.commons.extensions.isTargetSdkVersion30Plus
import com.dienvu.commons.helpers.PROTECTION_FINGERPRINT
import com.dienvu.commons.helpers.PROTECTION_PATTERN
import com.dienvu.commons.helpers.PROTECTION_PIN
    ...
    :PagerAdapter()
{
    ...
    private fun layoutSelection(position: Int): Int = when (position)
    {
        ...
        PROTECTION_FINGERPRINT ->
            if (context.isTargetSdkVersion30Plus()) R.layout.tab_biometric_id
            else R.layout.tab_fingerprint
